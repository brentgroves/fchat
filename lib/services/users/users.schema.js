...
exports.userSchema = typebox_1.Type.Object({
    ...
    microsoftId: typebox_1.Type.Optional(typebox_1.Type.Number()),
...
exports.userDataSchema = typebox_1.Type.Pick(exports.userSchema, ['email', 'password', 'githubId', 'microsoftId', 'avatar'], {
    $id: 'UserData',
...
exports.userQueryProperties = typebox_1.Type.Pick(exports.userSchema, ['id', 'email', 'githubId', 'microsoftId']);
