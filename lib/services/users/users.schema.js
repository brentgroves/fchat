...
exports.userDataSchema = typebox_1.Type.Pick(exports.userSchema, ['email', 'password', 'githubId', 'avatar'], {
    $id: 'UserData',
...
exports.userQueryProperties = typebox_1.Type.Pick(exports.userSchema, ['id', 'email', 'githubId']);
