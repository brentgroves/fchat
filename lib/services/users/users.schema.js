...
exports.userSchema = typebox_1.Type.Object({
    ...
    family_name: typebox_1.Type.Optional(typebox_1.Type.String()),
    given_name: typebox_1.Type.Optional(typebox_1.Type.String()),
    password: typebox_1.Type.Optional(typebox_1.Type.String()),
    githubId: typebox_1.Type.Optional(typebox_1.Type.Number()),
    // microsoftId:{ type: String },
    // microsoftId: Type.Optional(Type.Number()),  // The microsoftId has dashes in it.
    microsoftId: typebox_1.Type.Optional(typebox_1.Type.String()),
...
exports.userDataSchema = typebox_1.Type.Pick(exports.userSchema, ['email', 'name', 'family_name', 'given_name', 'password', 'githubId', 'microsoftId', 'avatar'], {
    $id: 'UserData',
...
exports.userQueryProperties = typebox_1.Type.Pick(exports.userSchema, ['id', 'email', 'name', 'family_name', 'given_name', 'githubId', 'microsoftId']);
